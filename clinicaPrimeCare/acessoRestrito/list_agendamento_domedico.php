...
// Recupere o código do médico da sessão
//echo "Código do médico logado: " . $codigo_medico; // exibir o código do médico

// Consulta SQL para obter os agendamentos do médico logado
$sql = "SELECT nome, data, horario, sexo, email FROM AGENDA WHERE codigo_medico = :codigo_medico AND data >= CURRENT_DATE()";
